...
// import { TypeDefinition, TypeDefinitionBool, TypeDefinitionFloat, TypeDefinitionID, TypeDefinitionInt, TypeDefinitionKW, TypeDefinitionRange, TypeDefinitionSequence, TypeDefinitionTagReceiver, TypeID, typeToVerbose } from './schema';
...
// 					for (let i = 0; i < field.expectedValueTypes.length; i++) {
// 						if (i >= field.values.length) {
// 							console.log("a");
// 						}
// 						else {
// 							const diagnostic = validateInput([field.values[i]], field.expectedValueTypes[i], context);
...
// 				};
// 			}
// 			const groupValidateResult = validateInput([values[0]], { type: TypeID.kw, group: definition.group }, c);
...
// 	return ((referenceType.type === TypeID.id) && (referenceType.group === "Condition"))
// }
...
// 		const statValidationResult = validateInput([valuesToValidate[0]], { type: TypeID.kw, group: "ActorStatType" }, c);
...
// 		const statValidationResult = validateInput([valuesToValidate[0]], { type: TypeID.kw, group: "ActorStatSubType" }, c);
// 		if (statValidationResult) {
// 			return statValidationResult;
// 		}
